...
$CANXLGEN $TESTIF -P -S 0 -A 0 -p 401 -l 1024:1024
$CANXLGEN $UNFRAGIF -P -S 0 -A 0 -p 001 -l 1024:1024
...
# create test data frame and segmented traffic
$CANXLGEN $TESTIF -P -S 0 -A 0 -p 421 -l 512:512
$CANXLGEN $UNFRAGIF -P -S 0 -A 0 -p 021 -l 512:512
